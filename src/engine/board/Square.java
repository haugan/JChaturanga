...
public abstract class Square {
    ...
    protected final int position; // position on Board from top-left to bottom-right; 0 to 63.
    ...
    /**
     * @return initial map of all Squares on Board. */
    ...
    public static Square createSquare(final int position, final Piece piece) {
        return piece != null
               ? new OccupiedSquare(position, piece)
