...
public class Board {
    ...
    public static Board initializeBoard() {
        ...
        b.setPiece(new Pawn(8, BLACK, true));
        b.setPiece(new Pawn(9, BLACK, true));
        b.setPiece(new Pawn(10, BLACK, true));
        b.setPiece(new Pawn(11, BLACK, true));
        b.setPiece(new Pawn(12, BLACK, true));
        b.setPiece(new Pawn(13, BLACK, true));
        b.setPiece(new Pawn(14, BLACK, true));
        b.setPiece(new Pawn(15, BLACK, true));

        // initial WHITE positions
        b.setPiece(new Pawn(48, WHITE, true));
        b.setPiece(new Pawn(49, WHITE, true));
        b.setPiece(new Pawn(50, WHITE, true));
        b.setPiece(new Pawn(51, WHITE, true));
        b.setPiece(new Pawn(52, WHITE, true));
        b.setPiece(new Pawn(53, WHITE, true));
        b.setPiece(new Pawn(54, WHITE, true));
        b.setPiece(new Pawn(55, WHITE, true));
